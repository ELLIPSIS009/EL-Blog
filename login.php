<?php
	...
	if(isset($_POST['tosubmit']))
	{
		...
		$sql = "SELECT logi FROM admins WHERE logi = '$myusername' and pass = '$mypassword'";	
		...
		if ($count==1)
		{
			...
			header("Location: admin_home.php?name=". $myusername);
		} else {
...
<html lang="en">
	...
	<nav class='nav_bar'>
		...
		<header class="masthead">
			<div class="login-page" style='width:1500px'>
				<div class="form">
				<h1 style='margin:0 0 25px 0'>Admin Login</h1><br>
